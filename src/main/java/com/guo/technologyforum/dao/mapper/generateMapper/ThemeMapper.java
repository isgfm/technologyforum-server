...
public interface ThemeMapper {
     ...
     * @mbg.generated
     */
    List<Theme> selectByExampleWithBLOBsWithRowbounds(ThemeExample example, RowBounds rowBounds);
     ...
     * @mbg.generated
     */
    List<Theme> selectByExampleWithBLOBs(ThemeExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("record") Theme record, @Param("example") ThemeExample example);
